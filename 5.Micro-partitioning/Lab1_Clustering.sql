...
// Observe time taken and no.of partitions scanned. Please execute these queries atleast after 30 mins of insertion as Snowflake take some time to move the data between partitions
